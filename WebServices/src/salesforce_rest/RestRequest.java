...
public class RestRequest {
  ...
  /*  static final String USERNAME     = "username@salesforce.com";
    ...
    public static void queryLeads(String baseUri,Header oauthHeader, Header prettyPrintHeader) {
    ...
    public static void createLeads(String baseUri, Header oauthHeader, Header prettyPrintHeader ) {
        ...
        try {
            ...
            lead.put("FirstName", "REST FirstName API");
            lead.put("LastName", "Rest Lead");
            lead.put("Company", "Cloud Solutions");
    ...
    public static void updateLeads(String baseUri, Header oauthHeader, Header prettyPrintHeader ) {
    ...
    public static void deleteLeads(String baseUri, Header oauthHeader, Header prettyPrintHeader ) {
