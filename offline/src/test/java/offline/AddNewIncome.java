...
public class AddNewIncome {
	...
	public void test() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.name("Add New Income")).click();
		Thread.sleep(3000);
		driver.findElement(
				By.xpath("//android.widget.EditText[@resource-id='com.expensemanager:id/expenseAmountInput']"))
				.sendKeys("80");
		Thread.sleep(2000);

		driver.findElement(By.xpath("//android.widget.ImageButton[@resource-id='com.expensemanager:id/editPayee']"))
				.click();
		Thread.sleep(2000);

		driver.findElement(By.name("My Employer")).click();
		Thread.sleep(2000);
